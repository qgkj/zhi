    ...
    if (typeof require === 'function' && typeof exports === 'object' && typeof module === 'object') {
        ...
        factory(window['H'] = {
            ...
            scrolltobottom: function (callback, threshold) {
                var that = this;
                threshold = Math.abs(typeof threshold === "number" ? threshold : 0);
             ...
             * @param {string} winUrl 窗口地址
             * @param {object} winPageParam 传递参数
             * @param {object} options 更多配置选项
			 * @returns void
			 */
            openWin: function (winName, winUrl, winPageParam, options) {
                ...
                o.name = winName;
                o.url = winUrl;
                o.pageParam = ((typeof winPageParam === "object") && winPageParam) ? winPageParam : {};
            ...
            openFrame: function (frameName, frameUrl, framePageParam, options) {
                ...
                o.name = frameName;
                o.url = frameUrl;
                o.pageParam = ((typeof framePageParam === "object") && framePageParam) ? framePageParam : {};
            ...
            openFrameGroup: function (callback, groupName, frames, index, options) {
                ...
                var o = {};
                o.name = groupName;
                o.index = Math.abs(typeof index === "number" ? index : 0);
            ...
            openPopoverWin: function (popoverWinName, popoverWinUrl, popoverWinpageParam, options) {
                ...
                o.url = popoverWinUrl;
                o.pageParam = ((typeof popoverWinpageParam === "object") && popoverWinpageParam) ? popoverWinpageParam : {};
            ...
            openSlidLayout: function (callback, fixedPane, slidPane, options) {
                ...
                if (!(typeof fixedPane === "object" && fixedPane)) {
                    console.error("fixedPane必须是frame对象");
                }
                if (!(typeof slidPane === "object" && slidPane)) {
            ...
            openSlidPane: function (type) {
                ...
                type = typeof type === "string" ? type : "left";
            ...
            openDrawerLayout: function (drawerName, drawerUrl, leftPane, rightPane, drawerPageParam, options) {
                ...
                o.pageParam = ((typeof drawerPageParam === "object") && drawerPageParam) ? drawerPageParam : {};
            ...
            pageUp: function (callback, isTop) {
                ...
                isTop = typeof isTop === "boolean" ? isTop : false;
                api.pageUp({
                    top: isTop
                }, function (ret, err) {
                    if (that.isFunction(callback)) {
            ...
            pageDown: function (callback, isBottom) {
                ...
                isBottom = typeof isBottom === "boolean" ? isBottom : false;
                api.pageUp({
                    bottom: isBottom
                }, function (ret, err) {
                    if (that.isFunction(callback)) {
            ...
            openApp: function (callback, url, appParam, options) {
                ...
                if (that.systemType == "ios") {
                    ...
                    if (appParam && typeof appParam === "object") {
                        o.appParam = appParam;
                    }
                } else {
                    if (url) {
            ...
            openWidget: function (callback, wgtID, wgtParam, options) {
                ...
                var o = {};
                o.id = wgtID;
                if (wgtParam && typeof wgtParam === "object") {
                    o.wgtParam = wgtParam;
                }
            ...
            ajax: function (callback, url, method, data, dataType, options) {
                ...
                if (data && typeof data === "object" && o.method == "post") {
                    o.data = data;
                }
            ...
            writeFile: function (callback, path, data, isAppend) {
                ...
                isAppend = typeof isAppend === "boolean" ? isAppend : false;
            ...
            clearCache: function (callback, timeThreshold) {
                ...
                timeThreshold = Math.abs(typeof timeThreshold === "number" ? timeThreshold : 0);
            ...
            notification: function (callback, notify, alarm) {
                ...
                if (notify) {
                    if (!(typeof notify === "object" && notify)) {
            ...
            startLocation: function (callback, isAutoStop) {
                var that = this;
                isAutoStop = typeof isAutoStop === "boolean" ? isAutoStop : true;
            ...
            call: function (type, number) {
                type = ((typeof type === "string") && (type)) ? type : "tel_prompt";
            ...
            setFullScreen: function (isFullScreen) {
                isFullScreen = typeof isFullScreen === "boolean" ? isFullScreen : true;
            ...
            setKeepScreenOn: function (isKeepOn) {
                isKeepOn = typeof isKeepOn === "boolean" ? isKeepOn : true;
            ...
            setScreenSecure: function (isSecure) {
                isSecure = typeof isSecure === "boolean" ? isSecure : true;
            ...
            setAppIconBadge: function (badge) {
                badge = Math.abs(typeof badge === "number" ? badge : 0);
                api.setAppIconBadge({
                    badge: badge
                });
            },
            ...
            showProgress: function (title, text, isModal, options) {
                var that = this;
                var o = {};
                o.modal = typeof isModal === "boolean" ? isModal : false;
                if (title) {
                    o.title = title;
                }
                if (text) {
            ...
            toast: function (callback, msg, duration, location) {
                ...
                msg = typeof msg == "object" ? (JSON.stringify(msg)) : msg;
                duration = Math.abs(typeof duration === "number" ? duration : 2000);
            ...
            openPicker: function (callback, type, date, title) {
                ...
                o.title = typeof title == "string" ? title : "选择时间";
            ...
            showFloatBox: function (iconPath, duration) {
                ...
                duration = Math.abs(typeof duration === "number" ? duration : 5000);
            ...
            fixIos7Bar: function (cssSelector) {
                var that = this;
            ...
            fixStatusBar: function (callback, cssSelector) {
                var that = this;
                ...
                var _offset = that.offset(cssSelector);
                if (that.isFunction(callback)) {
                    callback(_offset);
                }
            },
            ...
            openFrameIndexByClick: function (framesOption, headerToggleClass, footerSelector, triggerSelector, triggerActiveClass) {
                ...
                that.D(footerSelector + " " + triggerSelector + ":nth-child(1)").onclick();
            },
            openFrameGroupIndexByClick: function (callback, groupName, framesOption, index, isScroll, headerToggleClass, footerSelector, triggerSelector, triggerActiveClass, options) {
                ...
                index = Math.abs(typeof index === "number" ? index : 0);
